...
HD_PWD='C:/Users/ressw/Documents/School/ESE498/RSA/Axi4RSA/Axi4RSA.runs/design_1_Axi4RSA_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Axi4RSA_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Axi4RSA_0_0.tcl
